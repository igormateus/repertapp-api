...
public class VersionRequestValidation {
    ...
    public static void valideUpdate(
        VersionPutRequestBody versionRequest,
        Version version,
        VersionRepository repository
    ) {
        versionRepository = repository;
    ...
    private static void checkVersionToneAndRepertappUserAndMusicUnique(
        Tone tone,
        RepertappUser repertappUser,
        Music music
    ) {
